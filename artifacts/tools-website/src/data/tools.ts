...
export const TOOL_CATEGORIES: ToolCategory[] = [
  {
    ...
    tools: [
      ...
      { slug: "random-number-generator", title: "Random Number Generator", description: "Generate random numbers within any range you specify.", metaDescription: "Generate random numbers between any min and max value. Free online random number generator.", category: "Math & Calculators", implemented: false },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: "discount-calculator", title: "Discount Calculator", description: "Calculate the final price after any percentage discount.", metaDescription: "Find the discounted price of any item instantly. Free online discount calculator.", category: "Finance & Cost", implemented: false },
      ...
      { slug: "tip-calculator", title: "Tip Calculator", description: "Calculate the right tip amount and split bills easily.", metaDescription: "Calculate tip amount and split bills between people. Free online tip calculator.", category: "Finance & Cost", implemented: false },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: "temperature-converter", title: "Temperature Converter", description: "Convert between Celsius, Fahrenheit, and Kelvin.", metaDescription: "Convert temperatures between Celsius, Fahrenheit and Kelvin. Free online temperature converter.", category: "Conversion Tools", implemented: false },
  ...
  },
  {
    ...
    tools: [
      { slug: "bmi-calculator", title: "BMI Calculator", description: "Calculate your Body Mass Index from height and weight.", metaDescription: "Calculate your BMI (Body Mass Index) online. Free BMI calculator for adults and children.", category: "Health & Fitness", implemented: false },
