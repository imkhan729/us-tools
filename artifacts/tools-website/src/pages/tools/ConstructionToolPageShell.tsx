          ...
          <aside className="lg:col-span-1 space-y-8 lg:sticky lg:top-24 self-start">
            <div className="sticky top-24 space-y-6">
              <div className="bg-card border border-border rounded-2xl p-4">
                <h3 className="text-sm font-black uppercase tracking-tight text-foreground mb-3">Related Tools</h3>
                  ...
                  {relatedTools.map((tool) => (
                    ...
                    >
                      <div className="w-7 h-7 rounded-md flex items-center justify-center text-white flex-shrink-0 [&>svg]:w-3.5 [&>svg]:h-3.5"
                        style={{ background: "linear-gradient(135deg, hsl(42 70% 55%), hsl(42 75% 42%))" }}
                      >
              ...
              <div className="bg-card border border-border rounded-2xl p-4">
                ...
                <button
                  onClick={copyLink}
                  className="w-full flex items-center justify-center gap-2 py-2.5 bg-gradient-to-r from-amber-500 to-yellow-400 text-white text-sm font-bold rounded-xl hover:-translate-y-1 active:translate-y-0.5 transition-transform"
                >
                  {copied ? (
              ...
              <div className="bg-card border border-border rounded-2xl p-4">
                ...
                <div className="space-y-0.5">
                  {onThisPageItems.map((item) => (
                    <a key={item.href} href={item.href} className="flex items-center gap-2 text-xs text-muted-foreground hover:text-amber-500 font-medium py-1.5 transition-colors">
