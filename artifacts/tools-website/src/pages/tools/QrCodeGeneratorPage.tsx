    ...
    <ImageToolPageShell
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "PNG is a fixed-size raster export for quick sharing. SVG is vector-based, which makes it better for print, design files, and any layout that may scale.",
        },
        {
          q: "Why would I raise the error-correction level?",
          a: "Higher correction helps the code survive small print sizes, light damage, and noisier layouts. The tradeoff is a denser QR pattern that may need a larger export size.",
        },
        {
      ...
      relatedTools={[
        {
          ...
          benefit: "Resize exported QR assets for social posts, slide decks, and print layouts.",
        },
        {
          title: "Image Format Converter",
          href: "/image/image-format-converter",
          benefit: "Convert downloaded QR graphics into another file format for delivery.",
        },
        {
          title: "Social Media Image Resizer",
          href: "/social-media/online-social-media-image-resizer",
          benefit: "Place QR graphics into platform-specific post and story dimensions.",
        },
      ]}
      quickFacts={[
        {
          label: "Payload Types",
          value: "5 Modes",
          detail: "Switch between URL, text, Wi-Fi, email, and contact generation on one page.",
        },
        {
          label: "Export",
          value: "PNG + SVG",
          detail: "Download a quick raster file or a scalable vector depending on the workflow.",
        },
        {
          label: "Preview",
          value: "Live Refresh",
          detail: "Every content or style change updates the code immediately for fast validation.",
        },
      ]}
    />
  );
