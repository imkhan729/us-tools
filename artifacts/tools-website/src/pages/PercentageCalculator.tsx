          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section>
              ...
              <h1 className="text-4xl md:text-5xl font-black text-foreground tracking-tight leading-[1.1] mb-3">
                ...
                <span className="block text-2xl md:text-3xl font-bold text-blue-500 mt-1">
                  – Calculate Any Percentage Instantly, Free
                </span>
              </h1>

              <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-muted-foreground mb-4">
                <span><strong className="text-foreground">Category:</strong> Math &amp; Calculators</span>
                <span>·</span>
                <span><strong className="text-foreground">Last updated:</strong> March 2026</span>
              </div>

              <div className="flex flex-wrap gap-2 mb-5">
                <span className="inline-flex items-center gap-1.5 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 font-bold text-xs px-3 py-1.5 rounded-full border border-emerald-500/20">
                  <BadgeCheck className="w-3.5 h-3.5" /> FREE
                </span>
              ...
              <blockquote className="border-l-4 border-blue-500 pl-4 py-1 text-muted-foreground italic text-[15px]">
                Enter values → get instant result. No account needed.
              </blockquote>
            </section>
          ...
          <div className="space-y-6">
            <div className="sticky top-28 space-y-6">
                ...
                <div className="space-y-2">
                  {RELATED_TOOLS.map((tool) => (
                    ...
                    >
                      ...
                      <ChevronRight className="w-4 h-4 text-muted-foreground group-hover:text-blue-500 ml-auto opacity-0 group-hover:opacity-100 transition-all" />
                    </Link>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-card border border-border rounded-2xl p-5">
                ...
                <button
                  onClick={copyLink}
                  className="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-blue-500 to-cyan-400 text-white font-bold rounded-xl hover:-translate-y-0.5 active:translate-y-0 transition-transform"
                >
                ...
                <div className="space-y-1.5">
                  {[
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 text-sm text-muted-foreground hover:text-blue-500 font-medium py-1 transition-colors"
                    >
