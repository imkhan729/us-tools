...
import { ChevronRight, ArrowRight,
  ...
  Search as SearchIcon, Tag, MapPin, CloudSnow,
...
const TOOL_ICON_MAP: Record<string, React.ReactNode> = {
  ...
  "fraction-calculator": <Scale className="w-4 h-4" />,
  ...
  "time-calculator": <Clock className="w-4 h-4" />,
  ...
  "love-calculator": <Heart className="w-4 h-4" />,
  ...
  "snow-day-calculator": <CloudSnow className="w-4 h-4" />,
